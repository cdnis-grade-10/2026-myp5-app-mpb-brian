...
let schoolDepartments: [Department] = [
        ...
        Department(departmentIcon: "maths", departmentName: "Maths", departmentTeacher: [
            ...
            Teacher(teacherName: "Anita Desai",
                    ...
                    teahcerStory: "Numbers tell stories if you know how to listen to them. As a former actuary, I used statistics to predict the future for financial institutions. Now, I use those same concepts to help high school students understand everything from sports analytics to algorithm design. My goal is to completely eliminate 'math anxiety' in my classroom. I'm also the coach for the school's competitive math Olympiad team.",
            ...
            Teacher(teacherName: "Marcus Thorne",
                    ...
                    teahcerStory: "Middle school math is the bridge between basic arithmetic and abstract algebra, and it's my favorite age group to teach. I focus heavily on project-based learning—whether that's designing a virtual city to understand geometry or running a mock stock market to grasp percentages. I want my students to see math in the real world, not just in textbooks.",
        ...
        Department(departmentIcon: "science", departmentName: "Science", departmentTeacher: [
            ...
            Teacher(teacherName: "Dr. James Carter",
                    ...
                    teahcerStory: "Before coming to CDNIS, I worked as an aerospace engineer helping to design satellite propulsion systems. I bring that hands-on, engineering mindset directly into my physics labs. Whether we are building model rockets or analyzing the physics of a rollercoaster, I want students to understand the mechanics governing our universe. I also run the school's robotics club.",
            ...
            Teacher(teacherName: "Chloe Evans",
                    ...
                    teahcerStory: "Children are natural scientists—they are constantly asking 'why' and 'how'. My job is simply to give them the tools to find the answers. From mixing messy chemical reactions (safely!) to planting our own school garden to study plant life cycles, my classroom is a hands-on exploration zone. I am deeply passionate about fostering a love for STEM in young girls.",
        ...
        Department(departmentIcon: "music", departmentName: "Music", departmentTeacher: [
            ...
            Teacher(teacherName: "Samir Patel",
                    ...
                    teahcerStory: "I was a session drummer in Los Angeles before I realized I wanted to share the mechanics of music production with the next generation. As the Band Director, I oversee the jazz band, symphonic winds, and our digital music production classes. I believe modern music education should bridge the gap between classical theory and digital audio workstations (DAWs) like Logic and Ableton.",
        ...
        Department(departmentIcon: "pe", departmentName: "Physical Education", departmentTeacher: [
            ...
            Teacher(teacherName: "Tomoko Sato",
                    ...
                    teahcerStory: "Water is my second home. As a former competitive swimmer in Japan, I learned discipline, time management, and mental toughness. I bring these values to my high school PE classes and to the varsity swim team. I believe that physical education in the upper school should prepare students to maintain healthy, active lifestyles long after they graduate from CDNIS.",
